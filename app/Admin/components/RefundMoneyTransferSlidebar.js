...
import "./RefundMoneyTransferSlidebar.css"; // We will create this CSS file below

const RefundMoneyTransfer = () => {
  const [transactionNo, setTransactionNo] = useState("");
  const [data, setData] = useState([]); // Empty array to simulate "No Records"
  
  // Mock Summary Data (Static 0 as per screenshot)
  const summary = {
    pendingRequests: 0,
    pendingAmount: 0,
  };
  ...
  const handleSearch = () => {
    ...
    // For now, we keep data empty to match the screenshot's "No Records Exists!" state
  };
    ...
    <div className="dashboard-container colorful-bg">
      <div className="main-row">
        ...
        <main className="main-content">
          ...
          >
            <h2 className="page-title">Money Transfer Refund Pending</h2>
            <p className="page-subtitle">View and Claim your credit card transactions refund.</p>
          </motion.div>
          ...
          >
            {data.length === 0 ? (
              ...
              // If data exists, your table would go here
...
export default RefundMoneyTransfer;