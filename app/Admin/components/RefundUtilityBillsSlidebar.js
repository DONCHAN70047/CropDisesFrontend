...
import "./RefundUtilityBillsSlidebar.css";

const RefundPPI = () => {
  const [transactionNo, setTransactionNo] = useState("");
  const [data, setData] = useState([]); // Empty array to match screenshot
    ...
    <div className="dashboard-container colorful-bg">
      <div className="main-row">
        ...
        <main className="main-content">
          ...
          >
            <h2 className="page-title">PPI Transfer Refund Pending</h2>
            <p className="page-subtitle">View and Claim your ppi transfer refund.</p>
          </motion.div>
