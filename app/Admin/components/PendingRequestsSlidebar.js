...
import "./PendingRequestsSlidebar.css";

const PendingRequests = () => {
  // Set default dates to match screenshot style or use today's date
    ...
    <div className="dashboard-container colorful-bg">
      <div className="main-row">
        ...
        <main className="main-content">
          ...
          >
            <h2 className="page-title">Pending Fund Requests</h2>
            <p className="page-subtitle">View you all your pending fund requests.</p>
          </motion.div>

          {/* --- Control Bar (Cards + Search Filters) --- */}
          <motion.div 
